...
import org.apache.ibatis.submitted.serializecircular.DepartmentMapper;
...
/**
 * @author sky
 * @date 2020/2/21 - 8:05 下午
 */
public class DebugCacheTests {
...
//  }
  ...
  public void testSecondLevelCache() throws IOException{
    ...
    try{
      ...
      BlogMapper mapper2 = openSession2.getMapper(BlogMapper.class);

      Blog blog01 = mapper.selectByIdAndTitle(101,"mozi");
      System.out.println(blog01);
      openSession.close();

      //第二次查询是从二级缓存中拿到的数据，并没有发送新的sql
      //mapper2.addEmp(new Employee(null, "aaa", "nnn", "0"));
      Blog blog02 = mapper2.selectByIdAndTitle(101,"mozi");
  ...
  public void testFirstLevelCache() throws IOException{
    ...
    SqlSession openSession = sqlSessionFactory.openSession();
    try{
      BlogMapperAnnotation mapper = openSession.getMapper(BlogMapperAnnotation.class);
      Blog blog1 = mapper.select(100);
